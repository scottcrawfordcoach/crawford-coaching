---
 title: "14. A Failed Tactic Is Not A Failed Strategy"
 slug: "14-a-failed-tactic-is-not-a-failed-strategy"
 date: "Mar 10, 2026"
 dateIso: "2026-03-11"
 category: "Coaching"
 ...
 image: "./extracted-images/writing-14-a-failed-tactic-is-not-a-failed-strategy.webp"
 imageAlt: "14. A Failed Tactic Is Not A Failed Strategy"
 tags: "mindset,resilience,strategy,coaching"
---

by Scott Crawford

Want to try something new? [CHECK OUT THE PODCAST VERSION OF THIS BLOG (19mins)](https://yxndmpwqvdatkujcukdv.supabase.co/storage/v1/object/public/Blogcasts/14_Stop_Confusing_Strategy_With_Tactics.m4a)

Most people have set a goal at some point and failed to follow through.
...
There is a useful distinction, drawn from Simon Sinek’s work in [The Infinite Game](https://a.co/d/0h6RFSb1), between what I call infinite goals and finite goals.
...
[SMART goals](https://en.wikipedia.org/wiki/SMART_criteria) are everywhere. Specific, Measurable, Achievable, Realistic (or Relevant), Time-bound. It is probably the most widely taught goal-setting framework in the world, and for good reason. It works as a shaping tool.
...
In [Self-Compassion](https://a.co/d/0bjzRtQw), Kristin Neff distinguishes between beating yourself up and simply noticing what happened with honesty and kindness. Self-compassion is not about lowering the bar. It is about seeing clearly without the distortion of self-attack. From that clarity, the next step becomes visible.

Ryan Holiday, drawing on Stoic philosophy in [The Obstacle Is the Way](https://a.co/d/04UDy1FG), makes a similar point from a different angle. The obstacle is not a verdict. It is information. Difficulty tells you where the work is.
