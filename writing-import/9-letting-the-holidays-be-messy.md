---
 title: "9. Holiday Balance - Letting the Holidays Be Messy"
 slug: "9-letting-the-holidays-be-messy"
 date: "Dec 18, 2025"
 dateIso: "2025-12-19"
 category: "Coaching"
 readTime: "8 min read"
 excerpt: "Why easing control can make the season lighter"
 ogDescription: "Why easing control can make the season lighter"
 image: "./extracted-images/writing-9-letting-the-holidays-be-messy.webp"
 imageAlt: "9. Holiday Balance - Letting the Holidays Be Messy"
 tags: "mindset,habits,nutrition,balance"
---
...
This perspective is consistent with long-term behavior change research and with the broader message found in books like [Hidden Potential by Adam Grant](https://a.co/d/g8MSx1q), which emphasizes systems, character skills, and sustained environments over isolated acts of discipline. Progress is rarely derailed by pauses; it is derailed by rigid thinking that makes pauses feel like failure.
...
This aligns well with principles discussed in endurance and resilience-focused training frameworks, including those outlined by [Steve House in Training for the Uphill Athlete](https://a.co/d/0Zew3xe), where recovery, sustainability, and respect for context are treated as integral to performance rather than deviations from it.
...
This way of thinking echoes themes found in [Outlive by Peter Attia](https://a.co/d/gG0FbwO), where health is framed as a long game and short-term fluctuations are contextualized rather than catastrophized. The body is resilient. Metabolic health is cumulative.
...
In [Dare to Lead, Brené Brown](https://a.co/d/j3db7bG) remind us that boundaries are not barriers to connection; they are what make sustainable connection possible. Saying no, leaving early, taking time alone, or opting out of certain traditions is not failure. It is self-respect.
...
This idea shows up repeatedly in psychological research and in reflective works like [Creativity, Inc. by Ed Catmull](https://a.co/d/3iwyNCo), where excessive control is shown to stifle the very outcomes it aims to produce. The same principle applies to rest and connection.
...
In [Learned Optimism, Martin Seligman](https://a.co/d/gOvRjih) reminds us that flexible interpretation and realistic expectations are shown to protect wellbeing far more effectively than forced positivity.
