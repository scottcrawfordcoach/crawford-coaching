# Synergize Fitness — Group Training Information & Policies (v1.1)

> Human-readable legal record. The authoritative, hash-source copy is
> [`documents.js`](documents.js) (`canonicalText('group_policies')`). Keep this
> file in sync with that module; never edit one without the other.
>
> **v1.1 change:** required Media Consent section added (single choice of three).

Acknowledged with an acceptance boolean (`acknowledged: true`) **and** a required
media-consent choice (`media_consent` ∈ none / background / any).
...
- `none` — I do not consent to my likeness being used for social media or marketing purposes without express permission
- `background` — I am comfortable for my likeness to appear in the background of photos or videos for social media or marketing purposes
- `any` — I am happy for my likeness to be used at any time for marketing and social media purposes
