...
function markdownToHtml(markdown) {
  ...
  blocks.forEach((block) => {
    ...
    if (/^#{1,3}\s+/.test(trimmed)) {
      htmlBlocks.push(`<p>${inlineMarkdownToHtml(trimmed.replace(/^#{1,3}\s+/, ''))}</p>`);
      return;
    }
...
:root {
  --ink: #0e0f10; --slate: #1c2330; --mist: #a4b6c8; --pale: #dde8f2; --white: #ffffff;
...
.footer__social { display:flex; gap:1.2rem; align-items:center; }
.footer__social a { display:flex; align-items:center; justify-content:center; color:var(--mist); transition:color 0.2s; }
.footer__social a:hover { color:var(--pale); }
...
<nav class="nav">
  ...
  <ul class="nav__links">
    ...
    <li><a href="/timer">Interval Timer</a></li>
...
<main class="article-layout">
  <article class="article-main" aria-label=${JSON.stringify(`Blog article: ${data.title}`)}>
    <figure><img src="${escapeHtml(imagePath)}" alt="${escapeHtml(data.imageAlt)}"><figcaption>The visible goal is often only part of the story.</figcaption></figure>
...
<footer class="footer"><a href="/" class="footer__logo"><img src="/extracted-images/cc-logo.png" alt="Crawford Coaching"></a><ul class="footer__links"><li><a href="/coaching">Coaching</a></li><li><a href="/whole">WHOLE</a></li><li><a href="/synergize">Synergize Fitness</a></li><li><a href="/growth-zone">Growth Zone</a></li><li><a href="/about">About</a></li><li><a href="/writing">Writing</a></li><li><a href="/contact">Contact</a></li></ul><p class="footer__copy">&copy; 2026 Crawford Coaching</p><div class="footer__social">
    ...
    <a href="https://www.linkedin.com/in/scott-crawford-acc-9043b91a1/" target="_blank" aria-label="LinkedIn">
      <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
    </a>
    <a href="https://www.facebook.com/CrawfordCoachingKingston" target="_blank" aria-label="Facebook">
